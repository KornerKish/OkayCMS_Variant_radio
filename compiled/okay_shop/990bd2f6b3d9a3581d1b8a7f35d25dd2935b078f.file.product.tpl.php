<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-08-27 20:17:35
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '14989626465b7c5a5f2ea741-13378341',
  'function' => 
  array (
    'comments_tree' => 
    array (
  ...
  'unifunc' => 'content_5b7c5a5f3c6268_08588239',
  'variables' => 
  array (
    'product' => 0,
    'brand' => 0,
...
<?php if ($_valid && !is_callable('content_5b7c5a5f3c6268_08588239')) {function content_5b7c5a5f3c6268_08588239($_smarty_tpl) {?>
...
" data-fancybox="group"
                           data-caption="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
">
...
/images/no_image.png" width="340" height="340"
                             alt="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->name, ENT_QUOTES, 'UTF-8', true);?>
"/>
                    <?php }?>
...
" class="fn_wishlist selected product_wish"
                                       title="<?php echo $_smarty_tpl->tpl_vars['lang']->value->product_remove_favorite;?>
"
...
"
                                ...
                                <?php } else { ?>
                                    <a href="#" data-id="<?php echo $_smarty_tpl->tpl_vars['product']->value->id;?>
" class="fn_wishlist product_wish"
                                       title="<?php echo $_smarty_tpl->tpl_vars['lang']->value->product_add_favorite;?>
"
...
"
                                    ...
                                    <span class="rating_starOff">
                                        <span class="rating_starOn"
                                              style="width:<?php echo $_smarty_tpl->tpl_vars['product']->value->rating*90/sprintf('%.0f',5);?>
px;"></span>
                                    </span>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['product']->value->rating>0) {?>
                                        <span class="hidden"
                                              itemprop="reviewCount"><?php echo sprintf("%.0f",$_smarty_tpl->tpl_vars['product']->value->votes);?>
</span>
                                        <span class="hidden"
                                              itemprop="ratingValue">(<?php echo sprintf("%.1f",$_smarty_tpl->tpl_vars['product']->value->rating);?>
)</span>
...
:</span>
                            ...
                            <div class="available">
                                <span class="no_stock fn_not_stock<?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock>0) {?> hidden<?php }?>"
                                      data-language="product_out_of_stock"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_out_of_stock;?>
</span>

                                <span class="in_stock fn_in_stock<?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock<1) {?> hidden<?php }?>"
                                      data-language="product_in_stock"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_in_stock;?>
</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <?php if ($_smarty_tpl->tpl_vars['product']->value->variant_radio) {?>
                                    <br/>
                                    <div class="fn_variant <?php if (count($_smarty_tpl->tpl_vars['product']->value->variants)<2) {?> hidden<?php }?>">
...
?>
                                            <input type="radio" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" class="radio" name="variant"
...
"<?php }?>>
                                            <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value->name, ENT_QUOTES, 'UTF-8', true);?>
...
<span
                                            class="fn_units"><?php if ($_smarty_tpl->tpl_vars['product']->value->variant->units) {?>, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->variant->units, ENT_QUOTES, 'UTF-8', true);?>
<?php }?></span>:
                                </span>
                                ...
                                <div class="amount fn_product_amount">
                                    ...
                                    <input class="input_amount" type="text" name="amount" value="1"
                                           data-max="<?php echo $_smarty_tpl->tpl_vars['product']->value->variant->stock;?>
">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="price ">
                                    <span class="fn_price" itemprop="price"
                                          content="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->tpl_vars['product']->value->variant->price,'',false);?>
"><?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['convert'][0][0]->convert($_smarty_tpl->tpl_vars['product']->value->variant->price);?>
                                    ...
                                    <span itemprop="priceCurrency"
                                          content="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['currency']->value->code, ENT_QUOTES, 'UTF-8', true);?>
                            ...
                            <div class="col-sm-6 product_buttons">
                                <?php if (!$_smarty_tpl->tpl_vars['settings']->value->is_preorder) {?>
                                    ...
                                    <div class="fn_not_preorder <?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock>0) {?> hidden<?php }?>">
                                        <button class="disable_button" type="button"
                                                data-language="product_out_of_stock"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_out_of_stock;?>
</button>
                                    </div>
                                <?php } else { ?>
                                    ...
                                    <div class="fn_is_preorder <?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock>0) {?> hidden<?php }?>">
                                        <button class="button product_btn" type="submit"
                                                data-language="product_pre_order"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_pre_order;?>
</button>
                                    </div>
                                <?php }?>

                                
                                <button class="fn_is_stock button product_btn<?php if ($_smarty_tpl->tpl_vars['product']->value->variant->stock<1) {?> hidden<?php }?>"
                                        type="submit"
                                        data-language="product_add_cart"><?php echo $_smarty_tpl->tpl_vars['lang']->value->product_add_cart;?>
</button>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            <input class="form_input placeholder_focus" type="text" name="name"
                                                   value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment_name']->value, ENT_QUOTES, 'UTF-8', true);?>
"/>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form_group">
                                            <input class="form_input placeholder_focus" type="text" name="email"
                                                   value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comment_email']->value, ENT_QUOTES, 'UTF-8', true);?>
" data-language="form_email"/>
                                ...
                                <div class="form_group">
                                    <textarea class="form_textarea placeholder_focus" rows="3"
                                              name="text"><?php echo $_smarty_tpl->tpl_vars['comment_text']->value;?>
</textarea>
