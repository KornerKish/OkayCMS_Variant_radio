        ...
        if($this->request->method('post')) {
            ...
            if(!empty($ids)) {
                switch($this->request->post('action')) {
                    ...
                    case 'set_variant_radio': {
                        /*Установить как Radio*/
                        $this->products->update_product($ids, array('variant_radio'=>1));
                        break;
                    }
                    case 'unset_variant_radio': {
                        /*Убрать как Radio*/
                        $this->products->update_product($ids, array('variant_radio'=>0));
                        break;
                    }
