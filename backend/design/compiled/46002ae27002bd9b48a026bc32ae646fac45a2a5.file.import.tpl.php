<?php /* Smarty version Smarty-3.1.19-dev, created on 2018-09-11 20:00:10
         compiled from "backend\design\html\import.tpl" */ ?>
<?php /*%%SmartyHeaderCode:19993901435b7db0cd05dfd0-18484878%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '19993901435b7db0cd05dfd0-18484878',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19-dev',
  'unifunc' => 'content_5b7db0cd343418_77621214',
  'variables' => 
  array (
    'btr' => 0,
    'message_error' => 0,
...
<?php if ($_valid && !is_callable('content_5b7db0cd343418_77621214')) {function content_5b7db0cd343418_77621214($_smarty_tpl) {?><?php $_smarty_tpl->tpl_vars['meta_title'] = new Smarty_variable($_smarty_tpl->tpl_vars['btr']->value->import_products, null, 1);
...
<div class="row">
    <div class="col-lg-7 col-md-7">
        <div class="heading_page">
            ...
            <div class="export_block export_users hint-bottom-middle-t-info-s-small-mobile  hint-anim"
                 data-hint="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_example, ENT_QUOTES, 'UTF-8', true);?>
">
                            ...
                            <div class="okay_list">
                                <div class="okay_list_head">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        ...
                                        <div>
                                            <a href="javascript:;"
                                               class="btn btn_small btn-info fn_skip_all"><?php echo $_smarty_tpl->tpl_vars['btr']->value->import_skip_all;?>
</a>
                                            <a href="javascript:;"
                                               class="btn btn_small btn-info fn_new_all"><?php echo $_smarty_tpl->tpl_vars['btr']->value->import_new_all;?>
</a>
                                        </div>
                                    </div>
                                </div>
...
"/>
                                                <a href="javascript:;"
                                                   class="fn_edit_column <?php if (empty($_smarty_tpl->tpl_vars['column']->value->value)) {?>text_warning<?php } elseif ($_smarty_tpl->tpl_vars['column']->value->is_nf_selected) {?>text_green<?php }?>"
...
">
                                            <option value=""
                                                    data-label="<?php echo $_smarty_tpl->tpl_vars['btr']->value->import_skip;?>
"><?php echo $_smarty_tpl->tpl_vars['btr']->value->import_skip;?>
</option>
...
">
                                ...
                                <div class="okay_list_footer">
                                    <div class="col-lg-12 col-md-12 mt-1">
                                        <button type="submit" name="import" value="1"
                                                class="btn btn_small btn_blue float-md-right"><i
                                                    class="fa fa-upload"></i>&nbsp;<?php echo $_smarty_tpl->tpl_vars['btr']->value->import_do_import;?>
</button>
                                    </div>
                                </div>
                            </div>
                        <?php } elseif ($_smarty_tpl->tpl_vars['import']->value) {?>
                            <div id='import_result' class="boxes_inline" style="display: none;">
                                <a class="btn btn_small btn-info" href="index.php?module=ImportLogAdmin"
                                   target="_blank"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->import_log, ENT_QUOTES, 'UTF-8', true);?>
</a>
                            </div>
                            <div>
                                <progress id="progressbar" class="progress progress-xs progress-info mt-1"
                                          style="display: none" value="0" max="100"></progress>
                            </div>
                        <?php }?>
                    </div>
                </div>
 ...
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->general_kb, ENT_QUOTES, 'UTF-8', true);?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-6 my-h">
                                <button type="submit" class="btn btn_small btn_blue float-md-right"><i
                                            class="fa fa-upload"></i>&nbsp;<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['btr']->value->import_to_download, ENT_QUOTES, 'UTF-8', true);?>
</button>
                            </div>
                        </div>
                    </div>
